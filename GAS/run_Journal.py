...
def main(_kwargs):
    ...
    custom_settings = [
        {'crossover': OrderCrossover, 'pc': 0.5, 'mutation': CompositeMutation, 'pm': 0.5, 'selection': RouletteSelection(), 'local_search': [], 'pso': None, 'selective_mutation': None},  # APMS Setting
        ]
    GA_start = time.time()
