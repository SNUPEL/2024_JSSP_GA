                    ...
                    for i in range(len(self.ga_engines)):
                        ...
                        if target_index != i and sync_generation[i] % self.migration_frequency == 0:
                            ...
                            if new_populations[target_index]:
                                ...
                                # 이주 후 개체 초기화 상태 검증
                                # for individual in self.ga_engines[i].population.individuals:
                                #     if not individual.machine_order:
                                #         print(f"Error: Individual {individual.seq} has no machine_order after migration.")
                                #     else:
                                #         print(f"Individual {individual.seq} has valid machine_order: {individual.machine_order}")
                                ...
                                #     print(f"Before evaluation: Seq: {ind.seq}, Machine Order: {ind.machine_order}, Makespan: {ind.makespan}")

                                self.ga_engines[i].population.evaluate(self.config.target_makespan)

                                # for ind in self.ga_engines[i].population.individuals:
                                #     print(f"After evaluation: Seq: {ind.seq}, Machine Order: {ind.machine_order}, Makespan: {ind.makespan}")
